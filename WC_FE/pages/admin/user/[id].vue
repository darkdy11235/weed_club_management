        ...
        <div class="flex justify-between">
          <div class="w-3/5">
            <div class="input p-2 mb-4 w-3/4 relative">
              ...
              <div class="invalid-feedback text-left" v-if="errorValue.name">
                {{ errorValue.name }}
              </div>
            ...
            <div class="input p-2 mb-4 w-3/4 relative">
              ...
              <div class="invalid-feedback text-left" v-if="errorValue.age">
                {{ errorValue.age }}
              </div>
            ...
            <div class="input p-2 mb-4 w-3/4 relative">
              ...
              <div class="invalid-feedback text-left" v-if="errorValue.phone">
                {{ errorValue.phone }}
              </div>
            ...
            <div class="input p-2 mb-4 w-3/4 relative">
              ...
              <div class="invalid-feedback text-left" v-if="errorValue.email">
                {{ errorValue.email }}
              </div>
            ...
            <div class="input p-2 mb-4 w-3/4 relative">
              ...
              <div class="invalid-feedback text-left" v-if="errorValue.role">
                {{ errorValue.role }}
              </div>
            ...
            <div class="input p-2 mb-4 w-3/4 relative">
              ...
              <div class="invalid-feedback text-left" v-if="errorValue.status">
                {{ errorValue.status }}
              </div>
